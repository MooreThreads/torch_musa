...
class BasicEvaluation:
    ...
    def compute_queue_depth(self):
        ...
        This will return a list of Interval of queue depth data of musa launch and kernels.
        """
        assert self.profile.kineto_results is not None
        musa_event_list = self.profile.kineto_results.events()

        def is_musa_launch_kernel(e):
            # TODO: find a better way to identify musaLaunchKernel
            return e.name == "musaLaunchKernel"
        ...
        all_events = musa_launch_events + musa_kernel_events + self.events
    ...
    def rank_events(self, length):
        ...
        Parameters:
            length(int): The number of events to return.
        """
