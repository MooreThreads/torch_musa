#ifndef BUILD_TORCH_MUSA_CODEGEN_ATEN_MUSAFUNCTIONS_H_
#define BUILD_TORCH_MUSA_CODEGEN_ATEN_MUSAFUNCTIONS_H_
...
#endif // BUILD_TORCH_MUSA_CODEGEN_ATEN_MUSAFUNCTIONS_H_
