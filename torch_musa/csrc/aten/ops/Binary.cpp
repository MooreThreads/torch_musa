...
at::Tensor ATan2Tensor(const at::Tensor& self, const at::Tensor& other) {
...
at::Tensor& ATan2_Tensor(at::Tensor& self, const at::Tensor& other) {
  // No device check
...
TORCH_LIBRARY_IMPL(aten, PrivateUse1, m) {
  ...
  m.impl("atan2", &ATan2Tensor);
  m.impl("atan2_", &ATan2_Tensor);
  m.impl("atan2.out", &ATan2Tensor_out);
}
