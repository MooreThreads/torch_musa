...
void std_var_kernel_impl(
  ...
  using ops_t =
      WelfordOps<scalar_t, accscalar_t, int32_t, thrust::pair<out_t, out_t>>;
  at::native_musa_reduce::gpu_reduce_kernel<scalar_t, out_t, 2>(
...
void mean_kernel_impl(TensorIterator& iter) {
  ...
  at::native_musa_reduce::gpu_reduce_kernel<scalar_t, out_t>(
      iter, MeanOps<acc_t, factor_t>{factor});
}
