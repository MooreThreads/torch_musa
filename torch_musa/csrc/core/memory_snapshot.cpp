  ...
  return addCallback(
      at::RecordFunctionCallback(
          [](const at::RecordFunction& fn)
            ...
            c10::musa::MUSACachingAllocator::recordAnnotation(
      ...
      at::RecordFunctionCallback(
          [](const at::RecordFunction& fn)
            ...
            if (functionName.compare(
              ...
              c10::musa::MUSACachingAllocator::pushCompileContext(functionName);
            }
            return nullptr;
          },
          [](const at::RecordFunction& fn, at::ObserverContext* ctx_ptr) {
            ...
            if (functionName.compare(
                    0, functionNamePrefix.size(), functionNamePrefix) == 0) {
              c10::musa::MUSACachingAllocator::popCompileContext();
            }
          })
...
void _record_memory_history(
  ...
  auto when = c10::musa::MUSACachingAllocator::RecordContext::NEVER;
  if (trace_alloc_record_context) {
    when = c10::musa::MUSACachingAllocator::RecordContext::ALLOC;
...
void _record_memory_history(
  ...
  if (context) {
    if (context == "all") {
      when = c10::musa::MUSACachingAllocator::RecordContext::ALL;
...
std::string _memory_snapshot_pickled() {
  ...
  IValue last_allocator_settings_s = "PYTORCH_MUSA_ALLOC_CONF";
  ...
  IValue release_lock_on_malloc_s = "release_lock_on_musamalloc";
  IValue pinned_use_host_register_s = "pinned_use_musa_host_register";
