...
def get_cmake_cache_variables_from_file(
    ...
    for i, line in enumerate(cmake_cache_file, 1):
        ...
        # Almost any character can be part of variable name and value. As a practical matter,
        # we assume the type must be valid if it were a C variable name. It should match the
