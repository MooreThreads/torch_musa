...
### From Python Package
- [Package Download Link](https://oss.mthreads.com:9001/buckets/ai-product/browse/cmVsZWFzZS1yYy90b3JjaF9tdXNh)

```bash
# for Python3.8
pip install torch-2.2.0a0+git8ac9b20-cp38-cp38-linux_x86_64.whl
pip install torch_musa-1.3.0-cp38-cp38-linux_x86_64.whl

# for Python3.9
pip install torch-2.2.0a0+git8ac9b20-cp39-cp39-linux_x86_64.whl
pip install torch_musa-1.3.0-cp39-cp39-linux_x86_64.whl
...
#### Prerequisites
- [MUSA ToolKit](https://sh-code.mthreads.com/sw/musa_toolkit), including **musa_runtime**, **mcc** and **Math-X** (muBlas, muSparse, muRand)
- [MUDNN](https://sh-code.mthreads.com/sw/muDNN)
- [muThrust](https://sh-code.mthreads.com/sw/muThrust)
- [muAlg](https://sh-code.mthreads.com/sw/muAlg)
- [PyTorch Source Code](https://github.com/pytorch/pytorch/tree/v2.2.0)
...
To pull a docker image, use command `docker pull sh-harbor.mthreads.com/mt-ai/musa-pytorch-dev-${PYTHON}:${TAG}`

Optional `${PYTHON}` are `py38`, `py39` and `py310`, `${TAG}` can be found below:

| torch_musa | musa_toolkit | muDNN | mccl | Others | Docker tag |
| --- | --- | --- | --- | --- | --- |
| v1.1.0 | rc2.1.0 | rc2.5.0 | rc1.4.0 | muAlg-dev0.3.0 <br> muSparse-dev0.1.0 <br> muThrust-dev0.3.0 | rc2.1.0-v1.1.0-qy1 <br> rc2.1.0-v1.1.0-qy2 |
| v1.2.1 | rc3.0.1 | rc2.6.1 | rc1.6.1 | muAlg-1.12.1 <br> muThrust-1.12.1 | rc3.0.1-v1.2.1-qy1 <br> rc3.0.1-v1.2.1-qy2|
| v1.3.0 | rc3.1.0 | rc2.7.0 | rc1.7.0 | muAlg-1.12.1 <br> muThrust-1.12.1 | rc3.1.0-v1.3.0-qy1 <br> rc3.1.0-v1.3.0-qy2 |
...
To pull a docker image, use command `docker pull sh-harbor.mthreads.com/mt-ai/musa-pytorch-release-${PYTHON}:${TAG}`
