...
inductor_fallback_ops = {
    ...
    "aten._scaled_dot_product_attention_flash_musa.default",
    "aten._scaled_dot_product_attention_flash_musa_backward.default",
    "aten._scaled_dot_product_attention_math_musa.default",
    "aten._scaled_dot_product_attention_math_musa_backward.default",
