...
在 s4000 上，当输入数据类型是 flaot32 时，可以通过设置 TensorFloat32 来使能 TensorCore，从而加速计算过程。TensorFloat32 的加速原理可以参考 [TensorFloat‑32](https://pytorch.org/docs/stable/notes/cuda.html#tensorfloat‑32‑tf32‑on‑ampere‑devices) 。
...
详细用法请参考 [examples/cpp](https://github.mthreads.com/mthreads/torch_musa/tree/main/examples/cpp) 下内容
