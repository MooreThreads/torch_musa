...
project = u'摩尔线程Torch_MUSA开发者手册'
copyright = u'2023, MooreThreads'
author = u''
...
release = version
curfnpre=u'MooreThreads-Torch_MUSA-Developer-Guide-CN-v'
...
latex_documents = [
    (master_doc, curfn, u'摩尔线程Torch\_MUSA开发者手册',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'MooreThreads-Torch_MUSA-Developer-Guide-CN', u'MooreThreads Torch MUSA User Guide',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MooreThreads-Torch_MUSA-Developer-Guide-CN', u'MooreThreads Torch MUSA User Guide',
     author, 'MooreThreads', 'One line description of project.',
     'Miscellaneous'),
]
