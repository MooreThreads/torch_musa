...
# parse parameters
parameters=$(getopt -o rn:t:b:f:v:m:h:: --long name:,tag:,base_img:,docker_file:,python_verison:,musa_toolkits_url:,mudnn_url:,torch_musa_tag:,release,no_prepare,mccl_url:,torch_whl_url:,torch_musa_whl_url:,torchaudio_whl_url:,torchvision_whl_url:,help::, -n "$0" -- "$@")
...
while true;do
  case "$1" in
    ...
    --torchaudio_whl_url) TORCHAUDIO_WHL_URL=$2; shift 2;;
    --torchvision_whl_url) TORCHVISION_WHL_URL=$2; shift 2;;
