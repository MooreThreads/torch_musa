...
wget --no-check-certificate https://oss.mthreads.com/release-rc/cuda_compatible/${TAG}/musa_toolkits_${TAG}.tar.gz -P ${musa_toolkit_path}
tar -zxf ${musa_toolkit_path}/musa_toolkits_${TAG}.tar.gz -C ${musa_toolkit_path}
