...
#
# The following variables are optionally searched for default:
# cmake-format: off
...
find_path(
  MUSAToolkits_INCLUDE_DIR
  NAMES musa_runtime.h
  PATHS ${MUSAToolkits_INCLUDE_SEARCH_PATHS}
  NO_DEFAULT_PATH)
find_path(MUSAToolkits_INCLUDE_DIR NAMES musa_runtime.h NO_CMAKE_FIND_ROOT_PATH)

find_library(
  MUSAToolkits_LIBRARY
  NAMES musart
  PATHS ${MUSAToolkits_LIB_SEARCH_PATHS}
  NO_DEFAULT_PATH)
find_library(MUSAToolkits_LIBRARY NAMES musart NO_CMAKE_FIND_ROOT_PATH)

find_package_handle_standard_args(MUSAToolkits DEFAULT_MSG
                                  MUSAToolkits_INCLUDE_DIR MUSAToolkits_LIBRARY)
...
if(MUSAToolkits_FOUND)
  ...
  mark_as_advanced(
    MUSAToolkits_ROOT_DIR
    MUSAToolkits_LIBRARY_RELEASE
    MUSAToolkits_LIBRARY_DEBUG
    MUSAToolkits_LIBRARY
    MUSAToolkits_INCLUDE_DIR)
endif()
