...
import torch
import pytest
from torchvision.models import alexnet, resnet18, resnet34, resnet50, \
    resnet101, resnet152, vgg11, vgg11_bn, vgg13, vgg13_bn, vgg16, vgg16_bn, \
    vgg19, vgg19_bn
import torch_musa
from torch_musa import testing


models = [x() for x in [alexnet, resnet18, resnet34, resnet50, \
    resnet101, resnet152, vgg11, vgg11_bn, vgg13, vgg13_bn, vgg16, vgg16_bn, \
    vgg19, vgg19_bn]]
...
def test_module_musa(model):
    ...
    for model_param, model_cpy_param, model_musa_param, model_to_musa_param \
        in zip(model.parameters(), model_cpy.parameters(), \
            model_musa.parameters(), model_to_musa.parameters()):
    ...
    if testing.MULTIGPU_AVAILABLE:
        ...
        for model_param, model_musa_1_param, model_to_musa_1_param \
            in zip(model.parameters(), model_musa_1.parameters(), model_to_musa_1.parameters()):
