...
input_data = [
    {'input': np.random.randn(10),
     'other': np.random.randn(10)},
    {'input': np.random.randn(10, 10),
     'other': np.random.randn(10, 10)},
    {'input': np.random.randn(10, 0),
     'other': np.random.randn(10, 10)},
    {'input': np.random.randn(10, 10, 2),
     'other': np.random.randn(10, 10, 2)},
    {'input': np.random.randn(10, 10, 2, 2),
     'other': np.random.randn(10, 10, 2, 2)},
    ...
    {'input': np.array(1.2),
     'other': np.random.randn(30, 30)},
    {'input': np.random.randn(30),
     'other': np.array(1.2)},
    {'input': np.random.randn(30, 1),
     'other': np.random.randn(30, 30)},
    {'input': np.random.randn(30, 1),
     'other': np.random.randn(1, 30)},]
...
def test_add(input_data, data_type, other_scalar):
    cpu_result = torch.tensor(input_data['input'].astype(data_type), device="cpu") + other_scalar
    cpu_result_numpy = cpu_result.detach().numpy()
    mtgpu_result = torch.tensor(input_data['input'].astype(data_type), device="mtgpu") + other_scalar
